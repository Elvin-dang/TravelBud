    ...
    private void readBills(String tripKey) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                text_view_total.setText("Total : $"+total+"");
                if(currentUserLiability < 0) {
                    your_pay_text.setText("Your Pay : -$" + Math.abs(currentUserLiability)+"");
                }else {
                    your_pay_text.setText("Your Pay : $" +currentUserLiability+"");
                }
                perPerson_view_txt.setText("Per person : $"+perPerson+"");
            }
