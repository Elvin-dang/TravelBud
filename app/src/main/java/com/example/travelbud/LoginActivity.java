    ...
    protected void onStart() {
        ...
        if (firebaseUser != null) {
            ...
            if (local_timestamp == null) {
                ...
                try {
                    long diff =
                            sdf.parse(timestamp).getTime() - sdf.parse(local_timestamp).getTime();
                                                               ...
                                                               if (!task.isSuccessful()) {
                                                                   ...
                                                                   String timestamp =
                                                                           new SimpleDateFormat(
                                                                                   "yyyy.MM.dd.HH" +
                                                                                           ".mm.ss").format(new java.util.Date());
                                                                   ...
                                                                   editor.putString("user_token",
                                                                           loginTask.getResult().getUser().getUid());
                                                                   editor.putString("user_name",
                                                                           (String) task.getResult().getValue());
